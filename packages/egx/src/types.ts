...
export type EObject = {};
export type TObject = { [k: string]: TAny };
...
type HxTriggerModifier =
  ...
  | " queue:all"
  | " queue:none";
export namespace EGX {
  export type PureElement<T = EObject> = {
    type: string | FC<T>;
    props: T | null | undefined;
    key: number | string | null;
  };
  export type FCElement<T = EObject> = {
    type: FC<T>;
    props: TObject;
    key: number | string | null;
  };
